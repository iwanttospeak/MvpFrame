 ...
 * 选择图片和视频dialog，支持视频
 */
public class ChoosePicAndVideoDialog extends Dialog {
    ...
    public ChoosePicAndVideoDialog(@NonNull Context context) {
        this(context,R.style.image_dialog_style);
    }
    public ChoosePicAndVideoDialog(@NonNull Context context, @StyleRes int themeResId) {
    ...
    public ChoosePicAndVideoDialog setMultiple(boolean multiple) {
        isMultiple = multiple;
        return this;
    }

    public ChoosePicAndVideoDialog setCrop(boolean crop) {
        isCrop = crop;
        return this;
    }

    public ChoosePicAndVideoDialog setChooseNumber(int chooseNumber) {
        this.chooseNumber = chooseNumber;
        return this;
    }

    public ChoosePicAndVideoDialog setOnChoosePicListener(OnChoosePicListener onChoosePicListener) {
        ChoosePicAndVideoDialog.onChoosePicListener = onChoosePicListener;
        return this;
    }
