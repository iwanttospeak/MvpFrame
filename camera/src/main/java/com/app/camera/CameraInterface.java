...
import com.app.camera.util.AngleUtil;
import com.app.camera.util.CameraParamUtil;
import com.app.camera.util.CheckPermission;
import com.app.camera.util.DeviceUtil;
...
public class CameraInterface implements Camera.PreviewCallback {
    ...
    private CameraPreviewFrameListener cameraPreviewCallBack;
    public void setCameraPreviewFrame(CameraPreviewFrameListener callBack){
    ...
    public void setVideoFileAbsPath(String videoFileAbsPath) {
    ...
    public void onPreviewFrame(byte[] data, Camera camera) {
        if (cameraPreviewCallBack !=null){
            cameraPreviewCallBack.onPreview();
        }
...
//        }
        ...
        if (StringUtils.isSpace(videoFileAbsPath)){
            //TODO 文件和内容路径组合
