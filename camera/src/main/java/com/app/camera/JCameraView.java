...
import com.app.camera.lisenter.TypeListener;
import com.app.camera.state.CameraMachine;
import com.app.camera.util.FileUtil;
import com.app.camera.util.LogUtil;
import com.app.camera.util.ScreenUtils;
import com.app.camera.view.CameraView;
...
public class JCameraView extends FrameLayout implements CameraInterface.CameraOpenOverCallback, SurfaceHolder
        .Callback, CameraView ,CameraInterface.CameraPreviewFrameListener{
//    private static final String TAG = "JCameraView";
    ...
    public JCameraView(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        iconSrc = a.getResourceId(R.styleable.JCameraView_iconSrc, R.drawable.release_camera);
...
//                }
    ...
    public void onPreview() {
        mCaptureLayout.setCaptureButtonState(View.VISIBLE);
    }
    @Override
    ...
    public void onResume() {
        ...
        CameraInterface.getInstance().setCameraPreviewFrame(this);
...
//                    Log.i("CJT", "result = " + (result - firstTouchLength));
    ...
    public void setSaveAbsVideoPath(String path) {
        CameraInterface.getInstance().setVideoFileAbsPath(path);
    }
    ...
    public void showPicture(Bitmap bitmap, boolean isVertical) {
        ...
        mCaptureLayout.startTypeBtnAnimator(0);
    }
...
//                mFlashLamp.setImageResource(R.drawable.ic_flash_auto);
                ...
                break;
            case TYPE_FLASH_ON:
//                mFlashLamp.setImageResource(R.drawable.camera_photography_complete);
                machine.flash(Camera.Parameters.FLASH_MODE_ON);
                break;
            case TYPE_FLASH_OFF:
//                mFlashLamp.setImageResource(R.drawable.camera_photography_close);
